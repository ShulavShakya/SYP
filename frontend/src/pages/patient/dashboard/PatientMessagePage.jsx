...
const conversations = [
  {
    ...
    participantName: "Reception Desk",
    lastMessage: "Please come up to Suite 302 now.",
    time: "10:45 AM",
    active: true,
    unread: true,
    status: "Checked-in",
    referenceId: "CS-99201",
  ...
  },
  {
    id: 3,
    participantType: "staff",
    participantName: "Orthopedics Front Desk",
    lastMessage: "Is Dr. Smith running on time today?",
    time: "9:12 AM",
    active: false,
    unread: true,
    status: "Waiting",
    referenceId: "CS-99203",
  ...
  },
  {
    id: 4,
    participantType: "staff",
    participantName: "Pediatrics Help Desk",
    lastMessage: "Requesting appointment reschedule...",
    time: "08:00 AM",
    active: false,
    unread: false,
    status: "Active",
    referenceId: "CS-99204",
...
const messagesByConversation = {
  1: [
    ...
    },
    {
      id: 2,
      sender: "other",
      text: "Welcome! Please stay in your vehicle for a moment. Dr. Miller is just finishing with the previous patient. I'll send you a notification when it's time to head to Suite 302.",
      time: "10:44 AM",
    },
    {
      id: 3,
...
const quickActionsByRole = {
  patient: [
    "Ask about appointment time",
    "Share arrival update",
    "Request directions",
  ],
  receptionist: [
...
function getPageCopy(role) {
  if (role === "patient") {
    return {
      title: "Messages",
      subtitle: "Chat with your care team, doctors, and front desk staff",
      emptyTitle: "Select a conversation",
      emptyText:
        "Choose a conversation to view updates, ask questions, or manage your appointment.",
      searchPlaceholder: "Search staff, doctors, departments...",
      refLabel: "Case",
    };
  }
  ...
  return {
    title: "Messages",
    subtitle: "Manage patient conversations and check-ins",
    emptyTitle: "Select a conversation",
    emptyText:
      "Choose a patient conversation from the left panel to start managing messages.",
...
export default function MessagesPage() {
  ...
  const pageCopy = getPageCopy(viewerRole);
  const quickActions = quickActionsByRole[viewerRole] || [];
  ...
  const filteredConversations = useMemo(() => {
    ...
    return conversations.filter((item) => {
      const matchesSearch =
        ...
        item.referenceId.toLowerCase().includes(normalizedSearch) ||
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mb-1 text-[11px] font-bold uppercase tracking-wider text-[#006565]">
                        {pageCopy.refLabel}: {item.referenceId} •{" "}
                        {item.department}
                      </p>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <span className="truncate text-[11px] font-medium text-slate-400">
                          {pageCopy.refLabel}: {activeConversation.referenceId}{" "}
